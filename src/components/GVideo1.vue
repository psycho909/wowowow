...
import GYoutube from '../elements/GYoutube1.vue';
        ...
        <g-edit v-model:showEdit="showEdit" :uid="data.uid" v-if="page == 'EditPage'">
            ...
            <template #edit-content>
                ...
                <div class="g-edit__row">
                    ...
                    <div class="g-edit__col w50">
                        <g-input label="Mobile間距上:" type="number" v-model="videoData.mobile_mt"
                                 @change="handleNumber" />
                    </div>
                    <div class="g-edit__col w50">
                        <g-input label="Mobile間距下:" type="number" v-model="videoData.mobile_mb"
                                 @change="handleNumber" />
                    </div>
                </div>
